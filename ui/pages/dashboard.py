...
class DashboardWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            data['aylik_kalibrasyon'] = self._get_count(registry, "Kalibrasyon", f"YapilanTarih BETWEEN '{month_start}' AND '{month_end}' AND Durum = 'Planlandı'")
            ...
            data['gecmis_kalibrasyon'] = self._get_count(registry, "Kalibrasyon", f"BitisTarihi < '{today_str}' AND Durum = 'Yapıldı'")
...
class DashboardPage(QWidget):
    ...
    def _on_data_ready(self, data):
        ...
        self.card_aylik_kalibrasyon.set_data(data.get('aylik_kalibrasyon', 0), "Bu ay planlanan kalibrasyonlar")
