#!/usr/bin/env python3
"""
migrations.py dosyasında _seed_initial_data() metodunu güncelle.
"""
...
def update_migrations():
    """migrations.py dosyasını güncelle."""
    ...
    # Eski metodun sonunu bul (logger.info satırından sonra)
    # Bunun yerine, _migrate_to_v1 fonksiyonunun sonuna kadar olan kısmı bulalım
    
    # Bulunacak: "def _seed_initial_data" den "# =========================" başına kadar
    start_idx = content.find("def _seed_initial_data(self, cur):")
    end_idx = content.find("\n    # ================================================\n    # ACİL RESET", start_idx)
    ...
    # Yeni koduyla değiştir (indentation düşün)
    new_code = "    " + new_method.replace("\n", "\n    ").rstrip()
    ...
    print("✓ migrations.py güncellendi!")
    return True
